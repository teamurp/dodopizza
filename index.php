        ...
        <div class="row">   <!-- header -->
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
                <?php 
                    ...
                    $query2 = mysqli_query($con, "SELECT * FROM basket");                   
                ...
                <?php 
                 ...
                 ?>
                <h5>Сумма: <span><?php 
                $result = mysqli_query($con,'SELECT SUM(price) AS summ FROM  basket');
                $row = mysqli_fetch_assoc($result);
                $sum = $row['summ'];
                echo $sum ?></span> руб.</h5>
